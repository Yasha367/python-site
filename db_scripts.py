...
def add_questions():
    questions = [
        ('Fortinate or Babagee?', 'Babagee', 'Fortinate', 'ШО', 'WHAAT?!'),
        ('Babagee or IXBOIKES SERES IKES', 'Babagee', 'IXBOIKES SERES IKES', 'WTF?!', 'УХУХУХУХ'),
        ('Babagee or Plastaichon fivee', 'Plastaichon fivee', 'Babagee', 'WTF?!', 'Are u idiot?'),
        ('Plastaichon fivee or Logitek', 'Logitek', 'Plastaichon fivee', 'WTF?!', 'I don`t know')
    ]
    open()
